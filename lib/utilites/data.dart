import 'package:pizza_ui/models/pizza.dart';
...
final List<Pizza> pizzaList = [
  ...
  Pizza(
      ...
      price: "20.2",
      description:
          "Salami Supreme is a mouthwatering pizza delight that boasts a perfect harmony of savory flavors and zesty spices. Our signature dough is expertly crafted and baked to guiden perfection, serving as the canvas for a tantalizing combination of robust tomato sauce gooey melted cheese, and thinly sliced, savory salarms"),
  Pizza(
      name: "Capricciosa",
